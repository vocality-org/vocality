 ...
 *
 * @example
 * //input  -> [min, max]           // [regex name]: description
 * ""       -> [0, 100]             //
 * "100"    -> [0, 100]             // singleNumber: numbers from 0 to 100
 ...
 *
 * // (we include the boundary value 500)
 * "<500"   -> [-1000000, 500]   // upperBoundary: number under 500
 * "<-500"  -> [-1000000, -500]  // upperBoundary: numbers under -500
 * ">500"   -> [500, 1000000]    // lowerBoundary: numbers above 500
 * ">-500"  -> [-500, 1000000]   // lowerBoundary: numbers above -500
 *
...
export function parseMinMax(minMax: string): [number, number] | undefined {
  ...
  if (REGEX.singleNumber.test(minMax)) {
